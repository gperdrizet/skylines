...
if __name__ == '__main__':
    ...
    with tf.device('/gpu:0'):
        ...
        model_checkpoint=f'{config.PATH}/data/{run_date}/training_checkpoints/generator_model_f{checkpoint:07d}'
        ...
        for i in range(num_images):
            filename=f'{config.PATH}/data/{run_date}/specimens/{checkpoint}.{i}'
